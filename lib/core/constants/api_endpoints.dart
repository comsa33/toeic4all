class ApiEndpoints {
  ...
  static const String updateProfile = '$authVersion/me/profile';
  ...
  static const String passwordResetRequest =
      '$authVersion/password-reset/request';
  static const String passwordResetConfirm =
      '$authVersion/password-reset/confirm';
  ...
  static const String part5Answer =
      '$questionsVersion/part5/{question_id}/answer';
  ...
  static const String part5Difficulties =
      '$questionsVersion/part5/difficulties';

  // Questions endpoints - Part 6
  static const String part6Sets = '$questionsVersion/part6/';
  static const String part6Answer =
      '$questionsVersion/part6/{set_id}/answers/{question_seq}';
  static const String part6PassageTypes =
      '$questionsVersion/part6/passage_types';
  static const String part6Difficulties =
      '$questionsVersion/part6/difficulties';

  // Questions endpoints - Part 7
  static const String part7Sets = '$questionsVersion/part7/';
  static const String part7Answer =
      '$questionsVersion/part7/{set_id}/answers/{question_seq}';
  static const String part7SetTypes = '$questionsVersion/part7/set_types';
  static const String part7PassageTypes =
      '$questionsVersion/part7/passage_types';
  static const String part7PassageCombinations =
      '$questionsVersion/part7/passage_combinations';
  static const String part7Difficulties =
      '$questionsVersion/part7/difficulties';
